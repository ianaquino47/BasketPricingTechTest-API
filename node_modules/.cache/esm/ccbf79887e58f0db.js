let countItems,calculateSubtotal,checkForDiscounts,calculateDiscount,getConversion;_7e5‍.w("../helpermethods",[["countItems",["countItems"],function(v){countItems=v}],["calculateSubtotal",["calculateSubtotal"],function(v){calculateSubtotal=v}],["checkForDiscounts",["checkForDiscounts"],function(v){checkForDiscounts=v}],["calculateDiscount",["calculateDiscount"],function(v){calculateDiscount=v}],["getConversion",["getConversion"],function(v){getConversion=v}]]);const request = require("request"),
...
describe("Count items in a list", () => {
    describe("countItems", function() {
        it("returns an object - items: count", function(done) {
            ...
            _7e5‍.g.console.log(countItems(items))
            assert.deepEqual({ 
                Apples: 1, 
                Milk: 1, 
                Soup: 1 } 
